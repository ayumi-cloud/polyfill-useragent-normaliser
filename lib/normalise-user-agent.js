...
function UA(uaString) {
  ...
  if (!uaString) {
    ...
    if (
      ...
      uaString = uaString.replace(/(YaBrowser)\/(\d+)\.(\d+)\.(\d+) /, "");
    ...
    if (this.ua.family === "yandex browser") {
      if (this.ua.major === "18" && this.ua.minor === "9") {
        this.ua.family = "chrome";
        this.ua.major = "68";
        this.ua.minor = "0";
      }
      if (this.ua.major === "18" && this.ua.minor === "7") {
        this.ua.family = "chrome";
        this.ua.major = "67";
        this.ua.minor = "0";
      }
      if (this.ua.major === "18" && this.ua.minor === "6") {
        this.ua.family = "chrome";
        this.ua.major = "66";
        this.ua.minor = "0";
      }
      if (this.ua.major === "18" && this.ua.minor === "5") {
        this.ua.family = "chrome";
        this.ua.major = "65";
        this.ua.minor = "0";
      }
      if (this.ua.major === "18" && this.ua.minor === "4") {
        this.ua.family = "chrome";
        this.ua.major = "65";
        this.ua.minor = "0";
      }
      if (this.ua.major === "18" && this.ua.minor === "3") {
        this.ua.family = "chrome";
        this.ua.major = "64";
        this.ua.minor = "0";
      }
      if (this.ua.major === "18" && this.ua.minor === "2") {
        this.ua.family = "chrome";
        this.ua.major = "63";
        this.ua.minor = "0";
      }
      if (this.ua.major === "18" && this.ua.minor === "1") {
        this.ua.family = "chrome";
        this.ua.major = "63";
        this.ua.minor = "0";
      }
      if (this.ua.major === "17" && this.ua.minor === "11") {
        this.ua.family = "chrome";
        this.ua.major = "62";
        this.ua.minor = "0";
      }
      if (this.ua.major === "17" && this.ua.minor === "10") {
        this.ua.family = "chrome";
        this.ua.major = "61";
        this.ua.minor = "0";
      }
      ...
      if (this.ua.major === "17" && this.ua.minor === "8") {
        this.ua.family = "chrome";
        this.ua.major = "59";
        this.ua.minor = "0";
      }
      if (this.ua.major === "17" && this.ua.minor === "7") {
        this.ua.family = "chrome";
        this.ua.major = "59";
        this.ua.minor = "0";
      }
      if (this.ua.major === "17" && this.ua.minor === "6") {
        this.ua.family = "chrome";
        this.ua.major = "58";
        this.ua.minor = "0";
      }
      if (this.ua.major === "17" && this.ua.minor === "5") {
        this.ua.family = "chrome";
        this.ua.major = "57";
        this.ua.minor = "0";
      }
      if (this.ua.major === "17" && this.ua.minor === "4") {
        this.ua.family = "chrome";
        this.ua.major = "57";
        this.ua.minor = "0";
      }
      if (this.ua.major === "17" && this.ua.minor === "3") {
        this.ua.family = "chrome";
        this.ua.major = "56";
        this.ua.minor = "0";
      }
      if (this.ua.major === "17" && this.ua.minor === "2") {
        this.ua.family = "chrome";
        this.ua.major = "55";
        this.ua.minor = "0";
      }
      if (this.ua.major === "17" && this.ua.minor === "1") {
        this.ua.family = "chrome";
        this.ua.major = "55";
        this.ua.minor = "0";
      }
      if (this.ua.major === "16" && this.ua.minor === "11") {
        this.ua.family = "chrome";
        this.ua.major = "54";
        this.ua.minor = "0";
      }
      if (this.ua.major === "16" && this.ua.minor === "10") {
        this.ua.family = "chrome";
        this.ua.major = "51";
        this.ua.minor = "0";
      }
      if (this.ua.major === "16" && this.ua.minor === "9") {
        this.ua.family = "chrome";
        this.ua.major = "51";
        this.ua.minor = "0";
      }
      if (this.ua.major === "16" && this.ua.minor === "8") {
        this.ua.family = "chrome";
        this.ua.major = "51";
        this.ua.minor = "0";
      }
      if (this.ua.major === "16" && this.ua.minor === "7") {
        this.ua.family = "chrome";
        this.ua.major = "51";
        this.ua.minor = "0";
      }
      if (this.ua.major === "16" && this.ua.minor === "6") {
        this.ua.family = "chrome";
        this.ua.major = "50";
        this.ua.minor = "0";
      }
      if (this.ua.major === "16" && this.ua.minor === "5") {
        this.ua.family = "chrome";
        this.ua.major = "49";
        this.ua.minor = "0";
      }
      if (this.ua.major === "16" && this.ua.minor === "4") {
        this.ua.family = "chrome";
        this.ua.major = "49";
        this.ua.minor = "0";
      }
      if (this.ua.major === "16" && this.ua.minor === "3") {
        this.ua.family = "chrome";
        this.ua.major = "47";
        this.ua.minor = "0";
      }
      if (this.ua.major === "16" && this.ua.minor === "2") {
        this.ua.family = "chrome";
        this.ua.major = "47";
        this.ua.minor = "0";
      }
      if (this.ua.major === "16" && this.ua.minor === "1") {
        this.ua.family = "chrome";
        this.ua.major = "47";
        this.ua.minor = "0";
      }
      if (this.ua.major === "15" && this.ua.minor === "12") {
        this.ua.family = "chrome";
        this.ua.major = "46";
        this.ua.minor = "0";
      }
      if (this.ua.major === "15" && this.ua.minor === "11") {
        this.ua.family = "chrome";
        this.ua.major = "45";
        this.ua.minor = "0";
      }
      if (this.ua.major === "15" && this.ua.minor === "10") {
        this.ua.family = "chrome";
        this.ua.major = "45";
        this.ua.minor = "0";
      }
      if (this.ua.major === "15" && this.ua.minor === "9") {
        this.ua.family = "chrome";
        this.ua.major = "44";
        this.ua.minor = "0";
      }
      if (this.ua.major === "15" && this.ua.minor === "8") {
        this.ua.family = "chrome";
        this.ua.major = "43";
        this.ua.minor = "0";
      }
      if (this.ua.major === "15" && this.ua.minor === "7") {
        this.ua.family = "chrome";
        this.ua.major = "43";
        this.ua.minor = "0";
      }
      if (this.ua.major === "15" && this.ua.minor === "6") {
        this.ua.family = "chrome";
        this.ua.major = "42";
        this.ua.minor = "0";
      }
      if (this.ua.major === "15" && this.ua.minor === "5") {
        this.ua.family = "chrome";
        this.ua.major = "41";
        this.ua.minor = "0";
      }
      if (this.ua.major === "15" && this.ua.minor === "4") {
        this.ua.family = "chrome";
        this.ua.major = "41";
        this.ua.minor = "0";
      }
      if (this.ua.major === "15" && this.ua.minor === "3") {
        this.ua.family = "chrome";
        this.ua.major = "40";
        this.ua.minor = "0";
      }
      if (this.ua.major === "15" && this.ua.minor === "2") {
        this.ua.family = "chrome";
        this.ua.major = "40";
        this.ua.minor = "0";
      }
      if (this.ua.major === "15" && this.ua.minor === "1") {
        this.ua.family = "chrome";
        this.ua.major = "40";
        this.ua.minor = "0";
      }
      ...
      if (this.ua.major === "14" && this.ua.minor === "9") {
        this.ua.family = "chrome";
        this.ua.major = "36";
        this.ua.minor = "0";
      }
      ...
      if (this.ua.major === "14" && this.ua.minor === "6") {
        this.ua.family = "chrome";
        this.ua.major = "34";
        this.ua.minor = "0";
      }
      ...
      if (this.ua.major === "14" && this.ua.minor === "3") {
        this.ua.family = "chrome";
        this.ua.major = "32";
        this.ua.minor = "0";
      }
